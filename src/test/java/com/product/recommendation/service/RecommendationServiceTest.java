...
class RecommendationServiceTest {
    ...
    void recommendProductsTest() {
        ...
        List<Theme> userThemes = getUserThemesMockData();
        List<Theme> randomThemes = getRandomThemesMockData();
        List<Product> productsA = getProductsAMockData(userThemes);

        List<Product> productsB = getProductsBMockData(userThemes);

        List<Product> productsC = getProductsCMockData(userThemes);
    ...
    private List<Product> getProductsCMockData(List<Theme> userThemes) {
    ...
    private List<Product> getProductsBMockData(List<Theme> userThemes) {
        return Arrays.asList(
                Product.builder()
                        .id(201)
    ...
    private List<Product> getProductsAMockData(List<Theme> userThemes) {
        return Arrays.asList(
                Product.builder()
                        .id(101)
    ...
    private List<Theme> getRandomThemesMockData() {
        return Arrays.asList(
                Theme.builder().id(3001).name("Theme_C").TotalProducts(20).build());
    }

    private List<Theme> getUserThemesMockData() {
        return Arrays.asList(
